...
const noFlashScript = `(function(){try{var d=document.documentElement;var t=localStorage.getItem('portfolio-theme');d.dataset.theme=(t==='light'||t==='dark')?t:'dark';var p=localStorage.getItem('portfolio-palette');d.dataset.palette=(p==='terracotta'||p==='teal')?p:'current';var l=localStorage.getItem('portfolio-lang');if(l==='ar'||l==='en'){d.lang=l;d.dir=l==='ar'?'rtl':'ltr';}}catch(e){d.dataset.theme='dark';d.dataset.palette='current';}})();`;
