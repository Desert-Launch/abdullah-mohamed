...
export const en: Dictionary = {
    ...
    caseStudies: [
      {
        ...
        summary: "The core of an Arabic-first AI tutor now used by 20,000+ K-12 students.",
        challenge:
      ...
      },
      {
        ...
        summary: "A living-room trivia night turned into a fair, automated product with payments.",
        challenge:
    ...
    selectedWork: [
      ...
      },
      {
        key: "yolo",
        title: "YOLO",
        tagline: "Clinic operations: patients, appointments, inventory, and billing in one app.",
      ...
      },
      {
        key: "fastap",
        title: "FasTap",
        tagline: "Tap an NFC card to share a full profile — opens on any phone, no install.",
        image: appImages.fastap,
      },
      {
        key: "btc",
        title: "BTC",
        tagline: "Storefront + B2B wholesale ordering for a major gold & jewelry house.",
        image: appImages.btc,
      },
      {
        key: "qfight",
        title: "Q-Fight Gym",
        tagline: "Official app for a professional Muay Thai gym in Qatar, coached by Thai world-title fighters.",
        image: appImages.qfight,
      },
      {
        key: "almuslim",
        title: "Al-Muslim",
        tagline: "A daily Muslim companion: Quran, adhkar & duas, accurate prayer times, and qibla — with smart reminders.",
    ...
    experiences: [
      {
        ...
        summary: "Building the core of Faheem, an Arabic AI tutoring product used by 20,000+ K-12 students.",
        achievements: [
      ...
      },
      {
        ...
        summary: "Worked on social commerce and clinic management products across Egypt, Germany, and UAE deployments.",
        achievements: [
      ...
      },
      {
        ...
        summary: "Built and maintained white-label Flutter apps for independent and community pharmacies in the US.",
        achievements: [
      ...
      },
      {
        ...
        summary: "Worked on school management features for payments, chat, parent communication, and in-app commerce.",
        achievements: [
    ...
    plans: [
      {
        ...
        items: ["Code and system review", "Priority fixes list", "Technical direction call"],
      },
      {
        name: "Launch",
        fit: "For new MVPs",
        ...
        featured: true,
        items: ["Mobile or web app", "Backend and database", "Deploy and handoff docs"],
      },
      {
        name: "Partner",
        fit: "For ongoing delivery",
        body: "Senior engineering capacity for teams that need continuous product movement.",
        items: ["Roadmap execution", "Maintenance and scaling", "Weekly delivery rhythm"],
      },
    ],
    testimonials: [
      {
