  ...
  services: [
    {
      ...
      body: "الواجهة الأمامية، والواجهة الخلفية، وقاعدة البيانات، والبنية التحتية التي تعمل عليها — مهندس واحد، ومسؤولية تسليم واحدة. تسجيل الدخول، ولوحات التحكم، والصلاحيات حسب الأدوار، والتكاملات، وخط النشر. بالطريقة نفسها التي بنيت بها Xera Lab وTalia.",
    },
    {
    ...
    },
    {
      ...
      body: "iOS وAndroid من قاعدة كود واحدة ببنية نظيفة: تسجيل دخول، ومدفوعات، وتحليلات، وإشعارات، ودعم العمل دون اتصال، والإطلاق على المتجر — وليس مجرد واجهات.",
    },
  ],
