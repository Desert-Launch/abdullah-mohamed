...
export const ar: Dictionary = {
    ...
    hero: {
      eyebrow: "متاح لمشاريع فريلانس وأدوار هندسية متقدمة",
      title: "عبدالله محمد",
      roleLine: "مهندس برمجيات أول · منتجات ذكاء اصطناعي، موبايل، وفل-ستاك",
      tagline: "المهندس الذي تستعين به الفرق عندما يجب أن يُطلق المنتج فعلاً — ويصمد في الإنتاج.",
      lead: "أحوّل الأفكار غير الواضحة إلى أنظمة جاهزة للإطلاق: ميزات ذكاء اصطناعي، تطبيقات Flutter، واجهات خلفية، وخطوط النشر التي تُبقيها تعمل. أكثر من 10 تطبيقات على المتاجر في 4 مناطق — وليس مجرد واجهات.",
      primary: "اعمل معي",
    ...
    selectedWorkHeading: {
      ...
      title: "تطبيقات أخرى، على المتاجر.",
      body: "بعض المنتجات الأخرى التي بنيتها بالكامل — اضغط للانتقال إلى المتاجر.",
    },
    caseLabels: {
      challenge: "التحدي",
      role: "دوري",
    ...
    caseStudies: [
      {
        ...
        summary: "قلب مدرّس عربي بالذكاء الاصطناعي يستخدمه الآن أكثر من 20,000 طالب K-12.",
        challenge:
        ...
        stack: ["Flutter", "Azure OpenAI", "WebSocket", "Firebase", "Clean Architecture"],
      },
      {
        slug: "jaweb",
        title: "Jaweb",
        ...
        shots: ["/images/jaweb1.webp", "/images/jaweb2.webp", "/images/jaweb3.webp"],
        summary: "أمسية مسابقات عائلية تحوّلت إلى منتج عادل ذاتي التحكيم مع مدفوعات.",
        challenge:
    ...
    selectedWork: [
      {
        key: "imox",
        title: "IMOX",
        tagline: "تسوق اجتماعي بالفيديو — البائع ينشر ريلز والمشتري يشتري من الفيد.",
      ...
      },
      {
        key: "xera",
        title: "Xera Lab",
        tagline: "منصة إدارة حالات أسنان متكاملة — بوابة عملاء، لوحة إدارة، و Node.js API. بُنيت وسُلّمت للعميل.",
      },
      {
        key: "fastap",
        title: "FasTap",
      ...
      },
      {
        key: "qfight",
        title: "Q-Fight Gym",
        tagline: "التطبيق الرسمي لصالة مواي تاي احترافية في قطر، بتدريب أبطال تايلانديين حاصلين على ألقاب عالمية.",
        image: appImages.qfight,
      },
      {
        key: "almuslim",
        title: "المسلم",
        tagline: "رفيق المسلم اليومي: القرآن الكريم، الأذكار والأدعية، مواقيت صلاة دقيقة، واتجاه القبلة مع تذكيرات ذكية.",
    ...
    experiences: [
      {
        ...
        summary: "بناء قلب فهيم، منتج تعليمي عربي بالذكاء الاصطناعي يستخدمه أكثر من 20,000 طالب.",
        achievements: [
        ...
        apps: [
          ...
          },
          {
            ...
            stack: ["Flutter", "GraphQL", "Multi-app", "E-commerce", "Clean Architecture"],
          },
        ],
      },
      {
        ...
        summary: "العمل على منتجات تجارة اجتماعية وعمليات عيادات عبر مصر، ألمانيا، والإمارات.",
        achievements: [
      ...
      },
      {
        ...
        summary: "بناء وصيانة تطبيقات Flutter White-label لصيدليات مستقلة ومجتمعية في أمريكا.",
        achievements: [
      ...
      },
      {
        ...
        summary: "العمل على مزايا إدارة مدارس للمدفوعات، المحادثات، التواصل مع أولياء الأمور، والتجارة داخل التطبيق.",
        achievements: [
    ...
    freelanceProjects: [
      ...
      },
      {
        ...
        image: appImages.fastap,
        shots: ["/images/fastab1.webp", "/images/fastab2.webp", "/images/fastab3.webp"],
      ...
      },
      {
        ...
        stack: ["Flutter", "Riverpod", "MyFatoorah", "Stripe", "Firebase", "Apple PassKit"],
        metrics: [
    ...
    plans: [
      ...
      },
      {
        ...
        featured: true,
        items: ["تطبيق موبايل أو ويب", "باك إند وقاعدة بيانات", "نشر وتوثيق تسليم"],
      },
      {
        name: "شراكة",
        fit: "للتنفيذ المستمر",
