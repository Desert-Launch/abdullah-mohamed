...
export const ar: Dictionary = {
  ...
  meta: {
    ...
    cardEyebrow: "مهندس برمجيات أول · القاهرة، مصر · متاح للفريلانس",
    social:
      "تطبيقات ويب متكاملة، وذكاء اصطناعي فوري، ومنتجات موبايل من البداية للنهاية. أكثر من 10 تطبيقات تعمل في مصر والخليج وأوروبا وأمريكا.",
  },
