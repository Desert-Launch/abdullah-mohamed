...
export const ar: Dictionary = {
    ...
    hero: {
      ...
      lead: "مهندس برمجيات أول من القاهرة، أكثر من 3 سنوات في بناء وإطلاق تطبيقات إنتاجية من البداية للنهاية. أعمل حاليًا على فهيم — منصّة الذكاء الاصطناعي لوزارة التربية والتعليم المصرية، بتدريس صوتي فوري ودروس مولّدة بالذكاء الاصطناعي. أكثر من 7 تطبيقات منشورة في مصر وألمانيا والإمارات والولايات المتحدة. Flutter وNode.js وAWS — ومستعد للتكيّف مع",
    ...
    selectedWork: [
      {
        key: "voicers",
        title: "Voicers",
        tagline: "منصة صوت اجتماعية ثنائية اللغة غير منشورة لصناع المحتوى، VNotes، القوائم، المسابقات، وتفاعل الجمهور.",
