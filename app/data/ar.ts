...
export const ar: Dictionary = {
  ...
  plansHeading: {
    ...
    title: "أسعار البداية. النطاق النهائي بعد أن نتحدث.",
    body: "كل تعاون يبدأ بمكالمة مجانية. نستعرض المنتج والقيود وما الذي يعنيه النجاح — ثم أرسل عرضاً مكتوباً يتضمن السعر والجدول الزمني ومراحل الدفع. لا يبدأ شيء قبل موافقتك.",
  },
  processHeading: {
    eyebrow: "طريقة العمل",
  ...
  faq: [
    ...
    {
      q: "كيف يُحسب السعر؟",
      a: "لكل تعاون سعر يبدأ منه، والرقم النهائي يعتمد على النطاق. نبدأ بمكالمة مجانية، ثم أرسل عرضاً مكتوباً يغطي السعر والجدول الزمني ومراحل الدفع. توافق عليه قبل أن يبدأ أي عمل.",
    },
  ],
  testimonialsHeading: {
    eyebrow: "ماذا يقولون",
  ...
  // الأسعار أدناه هي حدود دنيا للبداية؛ السعر النهائي يُحدَّد لكل مشروع في العرض
  // المكتوب. لا مدد زمنية عمداً — الجدول الزمني يُحدَّد حسب كل مشروع.
  plans: [
    {
      name: "مراجعة معمارية",
      icon: "clock",
      ...
      price: "تبدأ من $900",
      priceNote: "الحد الأدنى — السعر النهائي يُحدَّد حسب حجم النظام ونطاقه",
      cta: "احجز مكالمة",
      items: [
        "مكالمة لتحديد النطاق، ثم تحليل معمّق غير متزامن لمستودعك",
        "مراجعة البنية والمخطط وتدفق البيانات",
        "تدقيق للأمان والتوسّع وتكلفة السحابة",
        "نتائج مكتوبة مع خطة عمل مرتّبة حسب الأولوية ينفّذها أي مهندس",
        "مكالمة متابعة لمراجعتها معاً",
    ...
    },
    {
      ...
      price: "تبدأ من $6,000",
      priceNote:
        "الحد الأدنى — السعر النهائي والجدول الزمني ومراحل الدفع تُحدَّد في العرض",
      cta: "لنحدد النطاق",
      featured: true,
      badge: "الأكثر طلباً",
      ...
      items: [
        ...
        "الواجهة الأمامية والخلفية وقاعدة البيانات والبنية التحتية مملوكة من البداية للنهاية",
        "تعدّد المستأجرين وصلاحيات حسب الأدوار عند الحاجة",
        ...
        "برنامج يعمل عند كل مرحلة — وإن لم تكن المرحلة الأولى صحيحة، نتوقف عندها",
      ],
    },
    {
      name: "شراكة شهرية",
      icon: "infinity",
      body: "قدرة سينيور محجوزة، شهراً بشهر.",
      price: "تبدأ من $2,500 / شهرياً",
      priceNote: "الحد الأدنى — الساعات المحجوزة والسعر يُحدَّدان حسب التعاون",
      cta: "لنناقش الاشتراك",
      itemsIntro: "كل ما في بناء المنتج، بالإضافة إلى:",
      items: [
        "قدرة هندسية سينيور محجوزة كل شهر",
        "تسليم مستمر وتخطيط لخارطة الطريق",
        "استجابة ذات أولوية",
        "تحسين التوسّع والأداء والتكلفة",
        "تقرير شهري ومراجعة معمارية",
